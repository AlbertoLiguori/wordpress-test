...
<input
class="form-control"
placeholder="<?php echo TrustindexPlugin_booking::___('e.g.:') . ' ' . esc_attr($exampleUrl); ?>"
id="page-link"
type="text"
required="required"
/>
...
<div class="results" data-errortext="<?php echo TrustindexPlugin_booking::___('Please add your URL again: this is not a valid %s page.', [ "Booking.com" ]); ?>"></div>
</div>
